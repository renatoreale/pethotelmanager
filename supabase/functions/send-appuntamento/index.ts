...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { data: tenant } = await supabaseAdmin
      .from("tenants")
      .select("name, logo_url, address, city, cap, phone, email, social_facebook_url, social_instagram_url, social_tiktok_url, social_whatsapp_url, appuntamento_email_body, appuntamento_email_subject")
